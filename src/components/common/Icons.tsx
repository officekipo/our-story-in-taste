...
export function HomeIcon({ color = INK, size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <path d="M3 11l9-9 9 9" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M5 9v10a1 1 0 001 1h4v-5h4v5h4a1 1 0 001-1V9" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}

export function StarTabIcon({ color = INK, size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function MapPinIcon({ color = INK, size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function ChartIcon({ color = INK, size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <rect x="3"  y="13" width="4" height="8" rx="1" fill={color} />
      <rect x="10" y="9"  width="4" height="12" rx="1" fill={color} opacity="0.7" />
      <rect x="17" y="5"  width="4" height="16" rx="1" fill={color} opacity="0.5" />
    </svg>
  );
}

export function ChatIcon({ color = INK, size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <path d="M17 3H7a2 2 0 00-2 2v14l4-3h8a2 2 0 002-2V5a2 2 0 00-2-2z" stroke={color} strokeWidth="1.8" strokeLinejoin="round" />
      <path d="M9 9h6M9 13h4" stroke={color} strokeWidth="1.8" strokeLinecap="round" />
    </svg>
  );
}
...
export function FlagIcon({ color = INK, size = 16 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
