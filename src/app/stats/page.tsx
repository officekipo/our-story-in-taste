...
export default function StatsPage() {
  ...
  const monthAvg = total > 0 ? (total / Math.max(Object.keys(byMonth).length, 1)).toFixed(1) : "0";

  return (
    <AppShell activeTab="stats" headerProps={{ visitedCount: total, avgRating: "4.5", wishCount: 3 }}>
