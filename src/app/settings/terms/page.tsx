    ...
    <div style={{ minHeight: "100vh", background: "#F5F0EB", maxWidth: 480, margin: "0 auto", fontFamily: "inherit" }}>
      ...
      <div style={{ padding: "24px 20px 48px", background: "#fff", margin: "12px 0" }}>
        ...
        <Section title="제7조 (이용자 의무)">
          ...
          • 음란, 폭력, 혐오 콘텐츠 게시<br />
          • 신체 노출 또는 성적 수치심을 유발하는 사진·영상 업로드<br />
        ...
        <Section title="제8조의2 (콘텐츠 정책 및 관리)">
          <p>① <strong>금지 콘텐츠</strong><br />
          이용자는 서비스 내(개인 기록·위시리스트·커뮤니티 포함)에 다음과 같은 콘텐츠를 업로드하거나 게시해서는 안 됩니다.<br />
          • 신체 노출, 성적 행위 또는 성적 수치심을 유발하는 사진·영상<br />
          • 폭력·혐오·차별을 조장하는 사진·텍스트<br />
          • 타인을 비방하거나 명예를 훼손하는 내용<br />
          • 불법 촬영물 등 정보통신망법을 위반하는 일체의 콘텐츠<br />
          • 맛집 방문 기록이라는 서비스 목적과 무관한 광고·스팸성 게시물</p>
          <p style={{ marginTop: 8 }}>② <strong>커뮤니티 공유 콘텐츠 관리</strong><br />
          커뮤니티에 공유된 콘텐츠는 회사 관리자가 내용 및 이미지를 검토할 수 있으며, 본 정책에 위반되는 경우 사전 통보 없이 삭제될 수 있습니다.</p>
          <p style={{ marginTop: 8 }}>③ <strong>위반 시 조치</strong><br />
          본 조를 위반한 이용자에 대해 회사는 다음 조치를 취할 수 있습니다.<br />
          • 해당 콘텐츠 즉시 삭제<br />
          • 서비스 이용 일시 정지 또는 영구 계정 해지<br />
          • 관련 법령에 따른 수사기관 신고</p>
          <p style={{ marginTop: 8 }}>④ <strong>개인 기록의 책임</strong><br />
          커플 간 비공개로 저장되는 개인 기록(방문 기록·위시리스트)에 업로드된 콘텐츠에 대한 법적 책임은 전적으로 이용자에게 있습니다. 회사는 해당 콘텐츠로 인해 발생하는 분쟁·손해에 대해 책임을 지지 않습니다.</p>
        </Section>

        <Section title="제9조 (서비스 중단 및 이용 제한)">
