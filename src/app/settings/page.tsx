  ...
  return (
    <Popup onClose={onClose}>
      ...
      <div style={{ display:"flex", gap:10 }}>
        ...
        <button onClick={handleSave} className="tap" style={{ flex:2, padding:12, background:ROSE, border:"none", borderRadius:12, color:"#fff", fontSize:14, fontWeight:700, cursor:"pointer", fontFamily:"inherit" }}>저장</button>
      </div>
    </Popup>
  );
}
    ...
    return (
      <Popup onClose={onClose}>
        <div style={{ textAlign:"center" }}>
          ...
          <button onClick={onClose} className="tap" style={{ width:"100%", padding:12, background:ROSE, border:"none", borderRadius:12, color:"#fff", fontSize:14, fontWeight:700, cursor:"pointer", fontFamily:"inherit" }}>확인</button>
        </div>
      </Popup>
    );
  }
    ...
    <Popup onClose={onClose}>
      ...
      <div style={{ marginBottom:12 }}>
        ...
        <div style={{ position:"relative" }}>
          ...
          <button onClick={()=>setShowCur(s=>!s)} className="tap" style={{ position:"absolute", right:12, top:"50%", transform:"translateY(-50%)", background:"none", border:"none", cursor:"pointer", fontSize:15, color:MUTED }}>
            {showCur?"🙈":"👁️"}
          </button>
        </div>
      ...
      <div style={{ marginBottom:12 }}>
        ...
        <div style={{ position:"relative" }}>
          ...
          <button onClick={()=>setShowNew(s=>!s)} className="tap" style={{ position:"absolute", right:12, top:"50%", transform:"translateY(-50%)", background:"none", border:"none", cursor:"pointer", fontSize:15, color:MUTED }}>
            {showNew?"🙈":"👁️"}
          </button>
        </div>
      ...
      <div style={{ marginBottom:16 }}>
        ...
        <div style={{ position:"relative" }}>
          ...
          <button onClick={()=>setShowConf(s=>!s)} className="tap" style={{ position:"absolute", right:12, top:"50%", transform:"translateY(-50%)", background:"none", border:"none", cursor:"pointer", fontSize:15, color:MUTED }}>
            {showConf?"🙈":"👁️"}
          </button>
        </div>
      ...
      <div style={{ display:"flex", gap:10 }}>
        <button onClick={onClose} className="tap" style={{ flex:1, padding:12, background:WARM, border:`1px solid ${BORDER}`, borderRadius:12, color:MUTED, fontSize:14, cursor:"pointer", fontFamily:"inherit" }}>취소</button>
        <button onClick={handleChange} className="tap" disabled={loading}
...
function ConfirmPopup({ emoji, title, desc, sub, confirmLabel, danger=false, onConfirm, onClose }: {
  ...
  return (
    <Popup onClose={onClose}>
      ...
      <div style={{ display:"flex", gap:10 }}>
        <button onClick={onClose} className="tap" style={{ flex:1, padding:12, background:WARM, border:`1px solid ${BORDER}`, borderRadius:12, color:MUTED, fontSize:14, cursor:"pointer", fontFamily:"inherit" }}>취소</button>
        <button onClick={onConfirm} className="tap" style={{ flex:2, padding:12, background:danger?RED:ROSE, border:"none", borderRadius:12, color:"#fff", fontSize:14, fontWeight:700, cursor:"pointer", fontFamily:"inherit" }}>{confirmLabel}</button>
      </div>
    </Popup>
  );
}
